# Retina Diabetic Macular Edema Finding - RetinaIntegration v0.5.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Retina Diabetic Macular Edema Finding**

## Resource Profile: Retina Diabetic Macular Edema Finding ( Experimental ) 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/RetinaIntegration/StructureDefinition/retina-diabetic-macular-edema-finding | *Version*:0.5.0 |
| Draft as of 2025-12-02 | *Computable Name*:RetinaDiabeticMacularEdemaFinding |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/dips.fhir.retinaintegration|current/StructureDefinition/retina-diabetic-macular-edema-finding)
