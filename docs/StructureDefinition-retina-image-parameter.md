# Retina Image Parameter - RetinaIntegration v0.6.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Retina Image Parameter**

## Resource Profile: Retina Image Parameter 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/RetinaIntegration/StructureDefinition/retina-image-parameter | *Version*:0.6.0 |
| Draft as of 2026-01-19 | *Computable Name*:RetinaImageParameter |

 
A structure describing an image for use in a operation. 

 
An Image parameter MUST consist of two codes: one for image quality (2000 series) and one for image view (6000 series). 
