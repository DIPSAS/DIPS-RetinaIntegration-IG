# Retina Observation - RetinaIntegration v0.6.0
...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/RetinaIntegration/StructureDefinition/retina-observation | *Version*:0.6.0 |
...
This profile is not to be instantiated directly. It is a base profile for other observation profiles. 
