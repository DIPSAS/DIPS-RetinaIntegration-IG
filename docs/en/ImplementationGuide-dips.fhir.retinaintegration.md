...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/retina-camera-device"
      },
      "name" : "Retina Camera Device",
    ...
    },
    {
      ...
      "description" : "Example of a Topcon retina camera device.",
      "exampleCanonical" : "http://dips.no/fhir/RetinaIntegration/StructureDefinition/retina-camera-device"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
