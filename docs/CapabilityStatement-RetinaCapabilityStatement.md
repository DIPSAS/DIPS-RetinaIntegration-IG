# Retina CapabilityStatement - RetinaIntegration v0.5.0
...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/RetinaIntegration/CapabilityStatement/RetinaCapabilityStatement | *Version*:0.5.0 |
