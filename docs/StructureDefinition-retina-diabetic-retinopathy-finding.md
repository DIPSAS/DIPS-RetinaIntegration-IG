# Retina Diabetic Retinopathy Finding - RetinaIntegration v0.6.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Retina Diabetic Retinopathy Finding**

## Resource Profile: Retina Diabetic Retinopathy Finding ( Experimental ) 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/RetinaIntegration/StructureDefinition/retina-diabetic-retinopathy-finding | *Version*:0.6.0 |
| Draft as of 2025-12-02 | *Computable Name*:RetinaDiabeticRetinopathyFinding |
